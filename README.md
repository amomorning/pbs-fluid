...
| --- | -------------------------------------------- | ------------------------------------------- | ------------------------------------------ | --------------------------------------- |
| MAC | ![](results/MAC_bilerp_euler_GS_False_False.gif \|width=250) | ![](results/MAC_bilerp_euler_GS_True_False.gif) | ![](results/MAC_cerp_rk3_GS_False_False.gif)   | ![](results/MAC_cerp_rk3_GS_True_False.gif) |
