...
# General settings:
resolutionX = 512
pixels = ti.field(ti.f32, shape=(resolutionX, resolutionX))
dt = 0.02
dx = 1.0
inv_dx = 1.0 / dx
...
# Grid settings:
_velocities = ti.Vector.field(2, ti.f32, shape=(resolutionX, resolutionX))
_new_velocities = ti.Vector.field(2, ti.f32, shape=(resolutionX, resolutionX))
velocity_divs = ti.field(ti.f32, shape=(resolutionX, resolutionX))
_pressures = ti.field(ti.f32, shape=(resolutionX, resolutionX))
_new_pressures = ti.field(ti.f32, shape=(resolutionX, resolutionX))
_diff_pressures = ti.field(ti.f32, shape=(resolutionX, resolutionX))
_dye_buffer = ti.field(ti.f32, shape=(resolutionX, resolutionX))
_new_dye_buffer = ti.field(ti.f32, shape=(resolutionX, resolutionX))
...
# CG settings:
b = ti.field(ti.f32, shape=resolutionX * resolutionX)
p = ti.field(ti.f32, shape=resolutionX * resolutionX)
Ax = ti.field(ti.f32, shape=resolutionX * resolutionX)
Ap = ti.field(ti.f32, shape=resolutionX * resolutionX)
r = ti.field(ti.f32, shape=resolutionX * resolutionX)
new_r = ti.field(ti.f32, shape=resolutionX * resolutionX)
