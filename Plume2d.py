...
class Plume2d():
    ...
    def set_zero(self):
        ...
        """
        # for x, y in self.u:
        #     if self.celltype[x-1, y] == 0 or self.celltype[x, y] == 0:
        #         self.u[x, y] = 0

        # for x, y in self.v:
        #     if self.celltype[x, y-1] == 0 or self.celltype[x, y] == 0:
        #         self.v[x, y] = 0 
    ...
    def set_pressure(self, x: int, y: int, rhs: float):
        ...
        """
        numerator = rhs + self.pressure[x-1, y] * self.celltype[x-1, y] \
